...
import com.example.da1_shoppingcart.adapter.MacHangConverseAdapter;
...
public class MacHangConverseAdminActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    MacHangConverseAdapter adapter,adapter2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<MacHang2> options2 = new FirebaseRecyclerOptions.Builder<MacHang2> ()
                .setQuery (FirebaseDatabase.getInstance ().getReference ().child ("MacHang").child ("Converse"),MacHang2.class).build ();
        adapter=new MacHangConverseAdapter (options2);
