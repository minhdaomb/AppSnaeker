...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById (R.id.recyclerView_MacHang_home);
        ...
        macHangViewAdapter2= new MacHangViewAdapter2 (HomeActivity.this,macHangg2List);
        recyclerView.setAdapter (macHangViewAdapter2);
        mDataAdidas.addChildEventListener (new ChildEventListener () {
            @Override
...
//        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId ()){
                    case R.id.nav_trangchu:
                        Intent z = new Intent (HomeActivity.this,HomeActivity.class);
                        startActivity (z);
                        break;
                    case R.id.nav_nike:
                        Intent i = new Intent (HomeActivity.this,NikeActivity.class);
                        startActivity (i);
                        break;
                    case R.id.nav_converse:
                        Intent a = new Intent (HomeActivity.this,ConverseActivity.class);
                        startActivity (a);
                        break;
                    case R.id.nav_adidas:
                        Intent s = new Intent (HomeActivity.this,AdidasActivity.class);
                        startActivity (s);
                        break;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.opt_1:
                Intent i = new Intent (HomeActivity.this,TheLoaiMacHangActivity.class);
                startActivity (i);
                break;
            case  R.id.otp_2:
                Intent a = new Intent (HomeActivity.this,MacHangActivity3.class);
                startActivity (a);
                break;
            case R.id.opt_3:
