...
public class MacHangAdidasAdapter extends FirebaseRecyclerAdapter<MacHang2, MacHangAdidasAdapter.MacHangViewHolder> {
    Context context;
    ...
    public MacHangAdidasAdapter(@NonNull FirebaseRecyclerOptions<MacHang2> options) {
        super (options);
            ...
            public void onClick(View view) {
                ...
                btnedit.setOnClickListener (new View.OnClickListener () {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance ().getReference ().child ("MacHang").child ("Adidas")
