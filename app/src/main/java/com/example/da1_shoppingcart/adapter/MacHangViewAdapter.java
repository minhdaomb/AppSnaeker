...
public class MacHangViewAdapter extends RecyclerView.Adapter<MacHangViewAdapter.ViewHodel> {
    Context context;
    ...
    public MacHangViewAdapter(Context context,ArrayList<MacHang2> macHang2List) {
