...
public class MacHangAdapter extends FirebaseRecyclerAdapter<MacHang2, MacHangAdapter.MacHangViewHolder> {
    Context context;
    ...
    public MacHangAdapter(@NonNull FirebaseRecyclerOptions<MacHang2> options) {
        super (options);
    ...
    protected void onBindViewHolder(@NonNull final MacHangViewHolder holder,final int position,@NonNull final MacHang2 model) {
        ...
        holder.imgdelete.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(holder.imageView.getContext ());
            ...
            public void onClick(View view) {
                ...
                btnedit.setOnClickListener (new View.OnClickListener () {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance ().getReference ().child ("MacHang").child ("Nike")
