...
public class AdidasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer=findViewById(R.id.drawer_layout_Adidas);
        ...
        recyclerView=findViewById (R.id.recyclerView_MacHang_Adidas);
        mDatabase=FirebaseDatabase.getInstance ();
        mStorage=FirebaseStorage.getInstance ();
        mData=mDatabase.getReference ().child ("MacHang").child ("Adidas");
        recyclerView.setHasFixedSize (true);
        recyclerView.setLayoutManager (new LinearLayoutManager (this));
        macHangg2List= new ArrayList<MacHang2> ();
        macHangViewAdapter2= new MacHangViewAdapter2 (AdidasActivity.this,macHangg2List);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId ()){
                    case R.id.nav_trangchu:
                        Intent z = new Intent (AdidasActivity.this,HomeActivity.class);
                        startActivity (z);
                        break;
                    case R.id.nav_nike:
                        Intent i = new Intent (AdidasActivity.this,NikeActivity.class);
                        startActivity (i);
                        break;
                    case R.id.nav_converse:
                        Intent a = new Intent (AdidasActivity.this,NikeActivity.class);
                        startActivity (a);
                        break;
                    case R.id.nav_adidas:
                        Intent s = new Intent (AdidasActivity.this,NikeActivity.class);
                        startActivity (s);
                        break;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.opt_1:
                Intent i = new Intent (AdidasActivity.this,TheLoaiMacHangActivity.class);
                startActivity (i);
                break;
            case  R.id.otp_2:
                Intent a = new Intent (AdidasActivity.this,MacHangActivity3.class);
                startActivity (a);
                break;
            case R.id.opt_3:
                Intent m = new Intent (AdidasActivity.this,CartActivity.class);
                startActivity (m);
                break;
        }
