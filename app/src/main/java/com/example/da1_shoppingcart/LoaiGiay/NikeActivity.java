...
public class NikeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer=findViewById(R.id.drawer_layout_Nike);
        ...
        recyclerView=findViewById (R.id.recyclerView_MacHang_Nike);
        mDatabase=FirebaseDatabase.getInstance ();
        mStorage=FirebaseStorage.getInstance ();
        mData=mDatabase.getReference ().child ("MacHang").child ("Nike");
        recyclerView.setHasFixedSize (true);
        recyclerView.setLayoutManager (new LinearLayoutManager (this));
        macHangg2List= new ArrayList<MacHang2> ();
        macHangViewAdapter2= new MacHangViewAdapter2 (NikeActivity.this,macHangg2List);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId ()){
                    case R.id.nav_trangchu:
                        Intent z = new Intent (NikeActivity.this,HomeActivity.class);
                        startActivity (z);
                        break;
                    case R.id.nav_nike:
                        Intent i = new Intent (NikeActivity.this,NikeActivity.class);
                        startActivity (i);
                        break;
                    case R.id.nav_converse:
                        Intent a = new Intent (NikeActivity.this,ConverseActivity.class);
                        startActivity (a);
                        break;
                    case R.id.nav_adidas:
                        Intent s = new Intent (NikeActivity.this,AdidasActivity.class);
                        startActivity (s);
                        break;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.opt_1:
                Intent i = new Intent (NikeActivity.this,TheLoaiMacHangActivity.class);
                startActivity (i);
                break;
            case  R.id.otp_2:
                Intent a = new Intent (NikeActivity.this,MacHangActivity3.class);
                startActivity (a);
                break;
            case R.id.opt_3:
                Intent m = new Intent (NikeActivity.this,CartActivity.class);
                startActivity (m);
                break;
        }
